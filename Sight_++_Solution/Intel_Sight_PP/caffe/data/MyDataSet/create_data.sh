...
# data_root_dir=/Users/xingdacen/Downloads/caffe/data/MyDataSet/  # Modify the path with your folder having Images and Labels directories.

data_root_dir="$cur_dir/"

dataset_name="Main"  # This will be directory holding train and test LMDBs

mapfile=labelmap_voc.prototxt  # Labelmap file for you dataset.
