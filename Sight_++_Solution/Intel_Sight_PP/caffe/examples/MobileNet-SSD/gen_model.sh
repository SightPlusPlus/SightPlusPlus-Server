...
sed -i'' -e "s/cls6x/${cls_num6}/g" $trainfile
sed -i'' -e "s/cls3x/${cls_num3}/g" $trainfile
sed -i'' -e "s/cls1x/${cls_num}/g" $trainfile

cp template/MobileNetSSD_test_template.prototxt $testfile
sed -i'' -e "s/cls6x/${cls_num6}/g" $testfile
sed -i'' -e "s/cls3x/${cls_num3}/g" $testfile
sed -i'' -e "s/cls1x/${cls_num}/g" $testfile
...
sed -i'' -e "s/cls6x/${cls_num6}/g" $deployfile
sed -i'' -e "s/cls3x/${cls_num3}/g" $deployfile
sed -i'' -e "s/cls1x/${cls_num}/g" $deployfile
